...
#
# Generated by Vivado on Wed Jul 29 19:47:39 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/MyProject/MyFPGA/SEA-Tutorial/Camera_Demo/Camera_Demo.cache/compile_simlib/activehdl"
  fi
