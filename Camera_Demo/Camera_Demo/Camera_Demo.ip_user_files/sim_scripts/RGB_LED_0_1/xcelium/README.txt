...
#
# Generated by export_simulation on Thu Jul 30 22:56:53 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './RGB_LED_0.sh' script.

./RGB_LED_0.sh -reset_run
...
./RGB_LED_0.sh -noclean_files

For more information on the script, please type './RGB_LED_0.sh -help'.
